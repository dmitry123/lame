	...
	priority(0)
{
	...
	this->SetOnScopeUpdate([](ScopePtr scope, ObjectPtr object) {
		...
		Bool isMethodImplemented = !object->CheckModificator(Object::Modificator::Native) &&
			object->CheckModificator(Object::Modificator::Implemented);

		Bool isMethod = object->CheckType(Object::Type::Method);
		Bool isInternal = object->CheckModificator(Object::Modificator::Internal);

		Uint32 line = object->GetNode() ? object->GetNode()->lex->line : 0;
		...
		if (self->CheckType(Object::Type::Interface)) {
			...
			if (isMethod && object->GetMethod()->GetNode()) {
